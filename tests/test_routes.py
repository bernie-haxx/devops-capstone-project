...
class TestAccountService(TestCase):
    ...
    def test_read_account(self):
        """
        It should read an account created and test its properties
        """
        # Account creation through AccountFactory Dummy Data and Response Generated
        account = self._create_accounts(1)[0]

        # Get response request and verify it's a 200_HTTP_OK
    ...
    def test_account_read_not_found(self):
        ...
        """
        # Get response request and assert HTTP_404_NOT_FOUND
        resp = self.client.get(
            f"{BASE_URL}/0",
            content_type="application/json"
            )
    ...
    def test_update_account(self):
        ...
        self.assertEqual(updated_account["name"], "Uga Booga")

    def test_account_not_found(self):
        """
        It should update an account with an account id that does not exist
        """
        # Get response request and assert HTTP_404_NOT_FOUND
        resp = self.client.put(
            f"{BASE_URL}/0",
